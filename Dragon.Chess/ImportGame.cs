...
//        private void ProcessAllMoves() {
//            if (this.Moves[0].Children.Count == 0) {
//                this.IsEmpty = true;
//                return;
//            }

//            foreach (var root in this.Moves[0].Children) {
//                this.ProcessMoveAndChildren(root)
//            }
//        }
